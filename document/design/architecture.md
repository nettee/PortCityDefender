...
无。本软件严禁外部程序访问，并需要添加严格的权限认证。详情参见“”。
...
| 运行控制 | 运行模块组合 |
|---|---|
| 查看情报列表 | 情报控制器-情报服务-用户服务-模态框服务 |
| 查看情报详情 | 情报详情控制器-情报详情服务-用户服务 |
| 回复情报 | 回复控制器-用户服务-回复服务 |
| 删除情报 | 情报详情控制器-情报详情服务 | 
| 发布情报 | 新建情报控制器-用户服务-情报服务-照相机服务-模态框服务 |

#### 指挥控制

| 运行控制 | 运行模块组合 |
|---|---|
| 查看自己收到的命令列表 | 命令控制器-用户服务 | 
| 查看自己发送的命令列表 | 命令控制器-用户服务 | 
| 查看自己收到的命令详情 | 接受命令详情控制器-命令服务-用户服务 | 
| 查看自己发送的命令详情 | 发送命令详情控制器-命令服务-用户服务 |
| 发送命令 | 新建命令控制器-联系人选择控制器-命令服务 |

#### 文档

| 运行控制 | 运行模块组合 |
|---|---|
| 查看文档 | 文档控制器-文档子类控制器-文档列表控制器-文档详情控制器-文档服务 |
...
| 查看情报详情时，该情报已被删除 | 弹框提示“该情报已被删除” | 自动返回情报页面，该情报消失 |
| 回复情报时，该情报已删除 | 弹框提示“该情报已被删除” | 自动返回情报界面，该情报消失 |
| 发送命令时，没有选择联系人 | 弹框提示“请选择联系人” | 自动返回新建命令界面 |
| 发送命令时，命令内容为空 | 弹框提示“命令内容不能为空” | 自动返回新建命令界面 |
